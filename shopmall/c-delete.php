<!--c.adminlist.php 에서 삭제 버튼을 눌렀을 때 실행되는 페이지-->
<?
...
echo ("
	...
	<tr><td colspan=2 align=center><form method=post action=c-delete2.php?code=$code><input type=submit value='삭제 확인'></form></td></tr>
